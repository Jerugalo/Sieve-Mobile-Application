...
public class TaskListManager {
    ...
    public static void setTasks(List<Task> tasks_){ tasks = tasks_; }
    public static List<Task> getTasks(){ return tasks; }

    public static List<Task> getProjectList(List<Task> tasks_){
        tasks = tasks_;
        return getProjectList();
    }
    public static List<Task> getProjectList(){
    ...
    public static List<Task> getProjectChildrenList(Task project, List<Task> tasks_){
        tasks = tasks_;
        return getProjectChildrenList(project);
    }
